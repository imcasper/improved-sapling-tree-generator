...
from add_curve_sapling_3_2_8.fabricate_stems import fabricate_stems
from add_curve_sapling_3_2_8.kickstart_trunk import kickstart_trunk
from add_curve_sapling_3_2_8.preform_pruning import perform_pruning
...
def grow_all_splines(base_size, base_size_s, bone_step, cu, leaf_base_size, leaf_settings, scale_val, tree_settings):
    ...
    for n in range(tree_settings.levels):
        ...
        close_tipp = all([(n == tree_settings.levels - 1), tree_settings.closeTip])
        ...
        # If this isn't the trunk then we may have multiple stem to initialize
            ...
            fabricate_stems(tree_settings, add_spline_to_bone, add_stem, base_size, child_points, cu, leaf_settings.leafDist, leaf_settings.leaves, leaf_settings.leafType, n, scale_val, store_n, bone_step)
        ...
        for st in stem_list:
            ...
            ratio, spline_to_bone = perform_pruning(tree_settings, base_size, child_points, cu, n, scale_val, spline_to_bone, st, close_tipp, bone_step, leaf_settings.leaves, leaf_settings.leafType)
