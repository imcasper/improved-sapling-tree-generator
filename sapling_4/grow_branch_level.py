...
def grow_branch_level(tree_settings: TreeSettings, baseSize, childP, cu, n, scaleVal, splineToBone, st, closeTip, noTip, boneStep, leaves, leafType, attachment):
    ...
    for k in range(tree_settings.curveRes[n]):
        ...
        for spl in tempList:
            ...
            grow_spline(tree_settings, n, spl, numSplit, splineList, splineToBone, closeTip, kp, boneStep)
