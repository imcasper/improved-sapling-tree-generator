...
def gen_leaf_mesh(leaf_settings: LeafSettings, loc, quat, offset, index, oldRot, ln):
    ...
    if leaf_settings.leafType in ['0', '5']:
        ...
        rotMat = Matrix.Rotation(oldRot + uniform(-leaf_settings.rotateV, leaf_settings.rotateV), 3, 'Y')
    ...
    if leaf_settings.leafType != '4':
        rotMat = Matrix.Rotation(oldRot + uniform(-leaf_settings.rotateV, leaf_settings.rotateV), 3, 'Z')
    ...
    if leaf_settings.leafType != '4':
        ...
        downRotMat = Matrix.Rotation(downAngle + downV + uniform(-leaf_settings.rotateV*0, leaf_settings.rotateV*0), 3, 'X')

    zVar = Matrix.Rotation(uniform(-leaf_settings.rotateV, leaf_settings.rotateV), 3, 'Z')
